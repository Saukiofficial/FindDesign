...
export default function Contact() {
    ...
    const validateForm = () => {
        if (!formData.name.trim()) {
            setSubmitError('Nama harus diisi');
            return false;
        }
        ...
        if (!formData.service) {
            setSubmitError('Pilih service yang dibutuhkan');
            return false;
        }
        if (!formData.message.trim()) {
            setSubmitError('Project details harus diisi');
            return false;
        }
        return true;
    };
    ...
    const handleSubmit = async (e) => {
        ...
        // Kredensial
        const serviceId = 'service_d3fypgc';
        const templateId = 'template_02ddqy9';
        const publicKey = 'sjO5dWAd8lYppdiEm';
        ...
        const templateParams = {
            ...
            to_email: 'saukiannaim046@gmail.com'
        };
    ...
    const contactInfo = [
        {
            ...
            title: 'Email',
            content: 'agusaffandi120@gmail.com',
            link: 'https://mail.google.com/mail/u/0/#inbox?compose=CllgCHrlGBDrRbsWHCkHZKJcZppqLDxhLKtGBBBNtpBJfhdmbMFhSKbgWQmGhRncqvNlsKjjngq'
        ...
        },
        {
            ...
            title: 'Whatsapp',
            content: '+6285259281373',
            link: 'https://wa.me/+6285259281373'
        },
        {
            icon: (
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            title: 'Location',
            content: 'Sumenep Jawa Timur, Indonesia',
            link: null
        }
    ];
                    ...
                    <div className="relative">
                        <div className="relative bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 md:p-10">
                            ...
                            <form onSubmit={handleSubmit} className="relative space-y-6">
                                ...
                                {isSubmitted && (
                                    <div className="text-center text-green-400 text-sm bg-green-500/10 border border-green-500/30 rounded-lg py-2 px-4 animate-pulse">
