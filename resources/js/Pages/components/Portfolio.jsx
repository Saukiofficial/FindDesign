        ...
        <>
            ...
            >
                <style>{`
                    ...
                    .fd-portfolio-image-box {
                        height: clamp(260px, 32vw, 430px);
                    }

                    @media (max-width: 640px) {
                        .fd-portfolio-image-box {
                            height: clamp(230px, 76vw, 350px);
                        }
                ...
                <div className="relative z-10 mx-auto max-w-[1600px]">
                    ...
                    <div className="mx-auto mb-12 max-w-4xl text-center lg:mb-16">
                        ...
                        <h2 className="fd-portfolio-title-shadow text-4xl font-black uppercase leading-none tracking-tight sm:text-6xl lg:text-7xl">
                            <span className="bg-gradient-to-b from-white to-zinc-400 bg-clip-text text-transparent">
                                Creative
                            </span>
                            <span className="ml-3 bg-gradient-to-b from-red-500 to-red-900 bg-clip-text text-transparent sm:ml-4">
                                Portfolio
                            </span>
                        </h2>

                        <p className="mx-auto mt-5 max-w-2xl text-sm font-semibold leading-relaxed text-white/78 sm:text-base lg:text-lg">
                        ...
                        <div className="fd-portfolio-grid">
                            {filteredItems.map((item, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className="absolute inset-x-0 bottom-0 top-6 rounded-[2rem] bg-gradient-to-b from-red-500/55 via-red-950/24 to-red-600/55 opacity-70 blur-[1px] transition duration-500 group-hover:opacity-100" />

                                        <div className="fd-portfolio-card-frame relative overflow-hidden border border-red-500/35 bg-[linear-gradient(180deg,rgba(52,8,8,0.78),rgba(4,4,4,0.9)_42%,rgba(2,2,2,0.96))] p-3 shadow-[0_0_50px_rgba(220,38,38,0.14)] transition-all duration-500 group-hover:-translate-y-2 group-hover:shadow-[0_0_75px_rgba(220,38,38,0.28)] sm:p-4">
                                            {/* IMAGE FULL TANPA TERPOTONG */}
                                            <div className="fd-portfolio-image-frame fd-portfolio-image-box relative overflow-hidden border border-red-500/25 bg-[radial-gradient(circle_at_center,rgba(127,29,29,0.24),rgba(0,0,0,0.96)_68%)]">
                                                {imageUrl ? (
                                                    <img
                                                        src={imageUrl}
                                                        alt={item.title}
                                                        ...
                                                        onError={(event) => {
                                                            event.currentTarget.src = `https://placehold.co/900x700/020202/ef4444?text=${encodeURIComponent(item.title || 'Portfolio')}`;
                                                        }}
                                                    />
                                                ) : (
                                                ...
                                                <div className="absolute left-4 top-4 rounded-full border border-red-500/40 bg-black/75 px-3 py-1.5 text-[0.62rem] font-black uppercase tracking-wider text-red-300 backdrop-blur">
                                                    {item.category}
                                                </div>
                                                ...
                                                <button
                                                    ...
                                                    className="absolute bottom-4 right-4 flex h-11 w-11 items-center justify-center rounded-full border border-red-500/50 bg-black/80 text-red-300 shadow-[0_0_24px_rgba(220,38,38,0.35)] transition hover:bg-red-600 hover:text-white"
                                            ...
                                            <div className="relative px-3 pb-5 pt-5 sm:px-4">
                                                <div className="mb-3 flex items-center gap-2 text-red-400">
                                                    ...
                                                    <span className="text-[0.62rem] font-black uppercase tracking-[0.22em]">
                                                        Featured Work
                                                    </span>
                                                </div>

                                                <h3 className="fd-portfolio-title-shadow text-xl font-black uppercase leading-tight text-white transition group-hover:text-red-300 sm:text-2xl">
                                                    {item.title}
                                                </h3>
                                                ...
                                                <button
                                                    type="button"
                                                    onClick={() => setSelectedItem(item)}
                                                    className="mt-5 inline-flex items-center gap-3 text-xs font-black uppercase tracking-wider text-red-400 transition hover:text-red-300"
                                                >
                                                    View Project
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="grid max-h-[92vh] overflow-y-auto lg:grid-cols-[1.25fr_0.75fr]">
                                <div className="flex min-h-[360px] items-center justify-center bg-[radial-gradient(circle_at_center,rgba(127,29,29,0.22),rgba(0,0,0,1)_72%)] p-4 lg:min-h-[620px]">
                                    <img
